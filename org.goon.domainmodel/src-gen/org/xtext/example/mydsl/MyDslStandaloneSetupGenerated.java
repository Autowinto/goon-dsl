...
public class MyDslStandaloneSetupGenerated implements ISetup {
	...
	public void register(Injector injector) {
		...
		Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put("goon", resourceFactory);
		IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("goon", serviceProvider);
	}
}
