...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            // Initialize Xtext Standalone setup (generated by Xtext) 
        	MyDslStandaloneSetupGenerated setup = new MyDslStandaloneSetupGenerated();
        	Injector injector = setup.createInjectorAndDoEMFRegistration();            // Create injector and get ResourceSet
            ...
            // Call generator (implementation IFileSystemAccess2 interface and IGeneratorContex)
